...
\begin{list1}
 \item
  \begin{tabular1bold}
   Open-Source Contributor, Julia Programming Language  &  \mbox{ } March 2013 -- Present\\
  \end{tabular1bold}

  \begin{tabular2}
   Spoke about Julia at developer conferences including JuliaCon, StrangeLoop, Strata, and YOW! \\
   Wrote a chapter on static analysis for the book \textit{500 Lines or Less} & Markdown\\
   Writing a book for O'Reilly titled \textit{Learning Julia} & ASCIIDoc, Julia\\
  \end{tabular2}
...
\begin{list1}
 \item
  \begin{tabular1bold}
   Co-founder, Madison Hack \& Tell & Madison, WI \mbox{ }\mbox{ }\mbox{ } Oct 2013 -- May 2014\\
  \end{tabular1bold}
 %\item
  \begin{tabular1bold}
