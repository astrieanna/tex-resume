...
\item \begin{tabular1bold} Senior Hardware/Software Engineer, Google; Madison, WI & 2013 -- Present \end{tabular1bold}
  ...
  \begin{list2}
  \item Hardware/software co-design for warehouse scale computers \hfill \emph{SystemVerilog} %FIXME: mixing tenses
...
\item \begin{tabular1bold} Student, Hacker School; New York, NY & Spring 2013 \end{tabular1bold}
  ...
  \item Macros and metaprogramming \hfill \emph {Julia} % FIXME: tense is wrong
...
\item \begin{tabular1bold} Member of Technical Staff, Centaur Technology (acquired by VIA); Austin, TX & 2005 -- 2013 \end{tabular1bold}
  ...
  \item The following is a typical six-month project (substituting a different ISA in our x86 processor):
    ...
    \item Helped reverse engineer the ISA
