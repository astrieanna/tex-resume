...
\item \begin{tabular1bold} Senior Hardware/Software Engineer, Google; Madison, WI & 2013 -- Present \end{tabular1bold}
  ...
  \begin{list2}
  \item Details confidential; hardware/software co-design for warehouse scale computers \hfill \emph{-} %FIXME: mixing tenses
  \item Order of magnitude latency improvement with multiple order of magnitude throughput improvement
  \end{list2}
